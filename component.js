...
define("nodes/components/driver-aliyunecs.linux-amd64/component", ["exports", "shared/mixins/node-driver"], function (exports, _nodeDriver) {
  "use strict";
  ...
  exports.default = Ember.Component.extend(_nodeDriver.default, {
    driverName: 'aliyunecs.linux-amd64',
    config: alias('model.aliyunecs.linux-amd64Config'),
    app: service(),
    init: function init() {
      var decodedLayout = window.atob(LAYOUT);
      var template = Ember.HTMLBars.compile(decodedLayout, {
        moduleName: 'nodes/components/driver-aliyunecs.linux-amd64/template'
      });
    ...
    bootstrap: function bootstrap() {
      var config = get(this, 'globalStore').createRecord({
        type: 'aliyunecs.linux-amd64Config',
        cpuCount: 2,
        memorySize: 2048
      });
      set(this, 'model.aliyunecs.linux-amd64Config', config);
    },
...
define("ui/components/driver-aliyunecs.linux-amd64/component", ["exports", "nodes/components/driver-aliyunecs.linux-amd64/component"], function (exports, _component) {
  "use strict";
